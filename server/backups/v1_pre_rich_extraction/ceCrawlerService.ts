...
export const startCrawlJob = async (jobId: string, url: string, selectors: CrawlerSelectors, profileId: string) => {
    console.log(`[Job:${jobId}] Starting crawl for ${url} (Profile: ${profileId})`);
